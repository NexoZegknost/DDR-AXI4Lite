...
HD_PWD='D:/Docs/Learning HCMUT/Logic design with HDL/Project 2 - Rework/DDR - AXI4Lite/DDR - AXI4Lite.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mem_controller_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mem_controller_top.tcl
