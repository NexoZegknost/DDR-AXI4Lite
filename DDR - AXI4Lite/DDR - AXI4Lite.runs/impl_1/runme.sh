...
HD_PWD='D:/Docs/Learning HCMUT/Logic design with HDL/Project 2 - Rework/DDR - AXI4Lite/DDR - AXI4Lite.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mem_controller_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mem_controller_top.tcl -notrace
