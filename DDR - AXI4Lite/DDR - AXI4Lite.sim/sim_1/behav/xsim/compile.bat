...
REM
REM Generated by Vivado on Fri Jun 05 00:29:51 +0700 2026
...
echo "xvlog --incr --relax -prj protocol_engine_tb_vlog.prj"
call xvlog  --incr --relax -prj protocol_engine_tb_vlog.prj -log xvlog.log
